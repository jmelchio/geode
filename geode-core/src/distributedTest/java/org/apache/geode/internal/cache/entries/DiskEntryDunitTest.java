...
public class DiskEntryDunitTest {
  private static final String LOG_PREFIX = "GEM-2712: ";
  ...
  @Test
  public void triggerGem2712Problems() {
    ...
    boolean exceptionOccurred =
        asyncInvocations.stream().anyMatch(AsyncInvocation::exceptionOccurred);
    ...
    return clients.stream().map(client -> client.invokeAsync(() -> {
      ...
      do {
        ...
        IntStream.range(0, 9).forEach(num -> {
          String mapKey = processId + "_key_" + mapKeyNum + "_" + num;
  ...
  private void dumpThreads() {
    ...
    }, servers.toArray(new VMProvider[0]));
  }
